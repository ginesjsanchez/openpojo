...
public class PojoPackageImplTest {
	...
	private static final int EXPECTED_CLASSES = 60;
	...
	public void testGetPojoClasses() {
		...
		Affirm.affirmEquals(String.format("classes added/removed to package=[%s]?", packageName), EXPECTED_CLASSES,
				counter);
	}

	@Test
	public void shouldReturnEmptyListNoAnnotation() {
		final PojoPackage pojoPackage = PojoPackageFactory
				.getPojoPackage(this.getClass().getPackage().getName() + ".packagenoannotation");
	...
	public void shouldReturnAnAnnotation() {
		final PojoPackage pojoPackage = PojoPackageFactory
				.getPojoPackage(this.getClass().getPackage().getName() + ".packagemanyannotations");
	...
	public void shouldReturnNullAnnotationNoPackageInfo() {
		final PojoPackage pojoPackage = PojoPackageFactory
				.getPojoPackage(this.getClass().getPackage().getName() + ".packagenopackageinfo");
	...
	public void shouldThrowIllegalArgumentException() {
		try {
			...
			final PojoPackage pojoPackage = new PojoPackageImpl(null);
			fail("Exception expected");
	...
	public void testtoString() {
		Assertions.assertEquals(expectedToString, pojoPackage.toString(), "toString format changed?!");
	}
}
