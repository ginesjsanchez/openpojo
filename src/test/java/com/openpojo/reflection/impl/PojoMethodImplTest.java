...
public class PojoMethodImplTest {
	...
	/**
	 * Test method for
	 * {@link com.openpojo.reflection.impl.PojoMethodImpl#getAnnotation(java.lang.Class)}.
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link com.openpojo.reflection.impl.PojoMethodImpl#isFinal()}.
	 */
	@Test
	...
	public void testIsPrivate() {
		...
		Affirm.affirmFalse("isPackagePrivate() check on method=[" + pojoMethod + "] returned true!!",
				pojoMethod.isPackagePrivate());
		Affirm.affirmFalse("isProtected() check on method=[" + pojoMethod + "] returned true!!",
				pojoMethod.isProtected());
	...
	public void isPackagePrivate() {
		...
		Affirm.affirmNotNull("method not found [" + prefix + "]", pojoMethod);
		Affirm.affirmTrue("isPackagePrivate() check on method=[" + pojoMethod + "] returned false!!",
				pojoMethod.isPackagePrivate());
	...
	public void testIsProtected() {
		...
		Affirm.affirmNotNull("method not found [" + prefix + "]", pojoMethod);
		Affirm.affirmTrue("isProtected() check on method=[" + pojoMethod + "] returned false!!",
				pojoMethod.isProtected());
		Affirm.affirmFalse("isPrivate() check on method=[" + pojoMethod + "] returned true!!", pojoMethod.isPrivate());
		Affirm.affirmFalse("isPackagePrivate() check on method=[" + pojoMethod + "] returned true!!",
				pojoMethod.isPackagePrivate());
...
//	}
	...
	public void shouldNotIncludeAbstractGetterMethod() {
		...
		String expectedGetterName = "get" + pojoField.getName().substring(0, 1).toUpperCase()
				+ pojoField.getName().substring(1, pojoField.getName().length());
		for (PojoMethod pojoMethod : pojoClass.getPojoMethods()) {

			if (pojoMethod.getName().equals(expectedGetterName))
				hasAbstractGetterMethod = true;
		}
		Assertions.assertTrue(hasAbstractGetterMethod);
		Assertions.assertEquals(1, pojoClass.getPojoFields().size());
		Assertions.assertFalse(pojoField.hasGetter());
	}
	...
	public void shouldNotIncludeAbstractSetterMethod() {
		...
		String expectedSetterName = "set" + pojoField.getName().substring(0, 1).toUpperCase()
				+ pojoField.getName().substring(1, pojoField.getName().length());
		for (PojoMethod pojoMethod : pojoClass.getPojoMethods()) {
		...
		Assertions.assertTrue(hasAbstractSetterMethod);
		Assertions.assertEquals(1, pojoClass.getPojoFields().size());
		Assertions.assertFalse(pojoField.hasGetter());
	}
}
