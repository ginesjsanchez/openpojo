...
public class CoberturaTest {
	...
	public void shouldHaveCoberturaPojoClassAdapter() {
		Assertions.assertEquals(CoberturaPojoClassAdapter.class,
				Cobertura.getInstance().getPojoClassAdapter().getClass());
	}

	@Test
	public void shouldHaveNoFilter() {
		Assertions.assertNull(Cobertura.getInstance().getPojoClassFilter());
	}

	@Test
	public void nameIsCobertura() {
		Assertions.assertEquals("Cobertura", Cobertura.getInstance().getName());
	}

	@Test
	public void coverageClassNameIs__netDOTsourceforgeDOTcoberturaDOTcoveragedataDOTLightClassmapListener() {
		Assertions.assertEquals("net.sourceforge.cobertura.coveragedata.LightClassmapListener",
