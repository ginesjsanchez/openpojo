...
public class Clover4Test {
	...
	public void shouldHaveCloverPojoClassAdapter() {
		Assertions.assertEquals(CloverPojoClassAdapter.class, Clover4.getInstance().getPojoClassAdapter().getClass());
	}

	@Test
	public void shouldHaveFilterCloverClasses() {
		Assertions.assertEquals(FilterCloverClasses.class, Clover4.getInstance().getPojoClassFilter().getClass());
	}

	@Test
	public void nameIsClover4() {
		Assertions.assertEquals("Clover 4", Clover4.getInstance().getName());
	}

	@Test
	public void coverageClassNameIs__com_atlassian_cloverDOTTestNameSniffer() {
		Assertions.assertEquals("com_atlassian_clover.TestNameSniffer", Clover4.getInstance().getCoverageClassName());
	}
}
