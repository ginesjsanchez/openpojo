...
public class FilterBasedOnInheritanceTest extends IdentitiesAreEqual {
	...
	public void givenDifferentInterfaces_shouldNotBeEqual() {
		...
		Assertions.assertFalse(instanceOne.equals(instanceTwo));
		Assertions.assertFalse(instanceTwo.equals(instanceOne));
		Assertions.assertTrue(instanceOne.hashCode() != instanceTwo.hashCode());

		FilterBasedOnInheritance instanceThree = new FilterBasedOnInheritance(null);
		Assertions.assertFalse(instanceOne.equals(instanceThree));
		Assertions.assertFalse(instanceThree.equals(instanceOne));
		Assertions.assertTrue(instanceOne.hashCode() != instanceThree.hashCode());
	}
