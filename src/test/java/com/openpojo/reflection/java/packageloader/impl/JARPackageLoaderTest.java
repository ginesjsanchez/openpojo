...
public class JARPackageLoaderTest {
	...
	private final String[] expectedSubPackagesNames = new String[] { packageName + ".chainsaw", packageName + ".config",
			packageName + ".helpers", packageName + ".jdbc", packageName + ".net", packageName + ".or",
			packageName + ".pattern", packageName + ".rewrite", packageName + ".spi", packageName + ".varia",
			packageName + ".xml" };
	...
	private final String[] expectedClassesNames = new String[] { "org.apache.log4j.Appender",
			...
			"org.apache.log4j.Level", "org.apache.log4j.LogMF", "org.apache.log4j.LogManager", "org.apache.log4j.LogSF",
			"org.apache.log4j.LogXF", "org.apache.log4j.Logger", "org.apache.log4j.MDC",
	...
	public final void shouldGetJarSubClasses() {
		...
		Affirm.affirmEquals(
				MessageFormatter.format("Classes added/removed to {0} found[{1}]?!", packageName, classesNames),
	...
	private JARPackageLoader getJarPackageLoader(final String packageName) {
		...
		Affirm.affirmEquals(MessageFormatter.format("[{0}] not located in a jar file!!", packageName), "jar",
