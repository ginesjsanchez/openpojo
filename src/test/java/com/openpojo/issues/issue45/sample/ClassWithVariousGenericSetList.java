...
public class ClassWithVariousGenericSetList {
	...
	public void setQueueOfQueueOfExtendsSomeGeneric(
			Queue<Queue<? extends SomeGeneric>> queueOfQueueOfExtendsSomeGeneric) {
	...
	public void setSetOfMapOfSomeInterfaceAndSomeGeneric(
			Set<Map<SomeInterface, SomeGeneric>> setOfMapOfSomeInterfaceAndSomeGeneric) {
