...
public class IssueTest {
	...
	public void shouldHideJacocoFieldAndMethod() throws NoSuchFieldException, NoSuchMethodException {
		...
		Assertions.assertNotNull(this.getClass().getDeclaredField("JACOCO_FIELD_NAME"));
		Assertions.assertNotNull(this.getClass().getDeclaredField("JACOCO_METHOD_NAME"));
		Assertions.assertNotNull(this.getClass().getDeclaredMethod("shouldHideJacocoFieldAndMethod"));
