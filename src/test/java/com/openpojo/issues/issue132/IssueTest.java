...
public class IssueTest {
	...
	public void hasNonSerializableInterface() {
		...
		AssertionError thrown = Assertions.assertThrows(AssertionError.class, () -> assertSerializable(clazz));

		Assertions.assertTrue(
				thrown.getMessage().contains("Field [someInterface] is an interface that allows non-Serializable "
						+ "types on a Serializable [" + clazz + "]"),
