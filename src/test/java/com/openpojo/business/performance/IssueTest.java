...
public class IssueTest {
	...
	public void identityFactoryGetHandler_MustAllowAccessWhileBeingModified() throws InterruptedException {
		...
		Assertions.assertTrue(firstJobResult && secondJobResult);
	}
	...
	private void verifyMethodIsSynchronized(Method method) {
		Assertions.assertTrue(Modifier.isSynchronized(method.getModifiers()));
	}
	...
	private void verifyMethodIsThreaded(int numberOfThreads, Method method) throws InterruptedException {
		...
		Assertions.assertTrue(identityFactory.isMultiThreaded());
	}

	private Method getIdentityFactoryDeclaredMethod(String methodName, Class<?>... parameters)
