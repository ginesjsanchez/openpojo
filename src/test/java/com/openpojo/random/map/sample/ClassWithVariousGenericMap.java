...
public class ClassWithVariousGenericMap {
	...
	private Map<Map<Object, SomeGeneric>, Map<SomeInterface, SerializableComparableObject>> mapOfMap_Object_SomeGeneric_And_MapOfSomeGeneric_SerializableComparableObject;

	private Map<Map<? extends SerializableComparableObject, ? extends SomeInterface>, Map<? extends SomeGeneric, ?>> mapOfMapOfExtendsSomeGeneric;
	...
	private Map<AbstractMap<ConcurrentHashMap<SomeGeneric, SomeGeneric>, EnumMap<EnumType1, SomeGeneric>>, HashMap<SimpleType1, SimpleType2>> mapOfAbstractMapOfConcurrentHashMapAndEnumMapAndHashMap;
	...
	public void setMapOfSuperSomeInterfaceSomeGeneric(
			Map<? super SomeInterface, ? super SomeGeneric> mapOfSuperSomeInterfaceSomeGeneric) {
	...
	public void setMapOfMap_Object_SomeGeneric_And_MapOfSomeGeneric_SerializableComparableObject(
			Map<Map<Object, SomeGeneric>, Map<SomeInterface, SerializableComparableObject>> mapOfMap_Object_SomeGeneric_And_MapOfSomeGeneric_SerializableComparableObject) {
		...
		this.mapOfMap_Object_SomeGeneric_And_MapOfSomeGeneric_SerializableComparableObject = mapOfMap_Object_SomeGeneric_And_MapOfSomeGeneric_SerializableComparableObject;
	}

	public void setMapOfMapOfExtendsSomeGeneric(
			Map<Map<? extends SerializableComparableObject, ? extends SomeInterface>, Map<? extends SomeGeneric, ?>> mapOfMapOfExtendsSomeGeneric) {
	...
	public void setMapOfMapOfSuperSomeGeneric(
			Map<Map<? super SomeGeneric, ? super SomeGeneric>, Map<? super SomeGeneric, ? super SomeGeneric>> mapOfMapOfSuperSomeGeneric) {
	...
	public void setMapOfSomeGenericListOfMapOfListQueue(
			Map<SomeGeneric, List<Map<List, Queue>>> mapOfSomeGenericListOfMapOfListQueue) {
	...
	public void setMapOfAbstractMapOfConcurrentHashMapAndEnumMapAndHashMap(
			Map<AbstractMap<ConcurrentHashMap<SomeGeneric, SomeGeneric>, EnumMap<EnumType1, SomeGeneric>>, HashMap<SimpleType1, SimpleType2>> mapOfAbstractMapOfConcurrentHashMapAndEnumMapAndHashMap) {
	...
	private void assertParameters(Object input, Class<?>... expectedTypes) {
		LoggerFactory.getLogger(this.getClass())
				.debug("Checking: [" + input + "] with types " + Arrays.toString(expectedTypes));
