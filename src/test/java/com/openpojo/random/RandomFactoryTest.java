...
public class RandomFactoryTest {
	...
	/**
	 * Test method for
	 * {@link com.openpojo.random.RandomFactory#addRandomGenerator(com.openpojo.random.RandomGenerator)}
	 * .
	 */
	@Test
	...
	public void testRandomLoop() {
		...
		Assertions.assertNotNull(RandomFactory.getRandomValue(Employee.class));
		Assertions.assertNotNull(RandomFactory.getRandomValue(Employee.class));
	}
	...
	public void shouldGenerateAbstract() {
		com.openpojo.random.sampleclasses.AnAbstractClass anAbstractClass = RandomFactory
				.getRandomValue(com.openpojo.random.sampleclasses.AnAbstractClass.class);
		Assertions.assertNotNull(anAbstractClass);
	}
	...
	public void generateRandomWithNoRegisteredRandomGenerator() {
		...
		Affirm.affirmFalse(
				String.format("Non randomized instance returned (i.e. same object) for [%s]", clazz.getName()),
	...
	public void shouldRegisterHierarchyOfTypes() {
		...
		Affirm.affirmNotNull(
				String.format("RandomFactory failed to retrieve random instance for interface [%s]", someInterface),
				instance);
	...
	public void shouldPopulateFieldsWithBusinessKeys() {
		...
		//// Assertions.//assertThat(classWithBusinessKey.getSomeKey(), notNullValue());
	}
