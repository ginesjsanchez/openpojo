...
public class AClassWithExhaustiveCollection {
	...
	public void setCollectionOfCollectionOfSomeGeneric(
			Collection<Collection<SomeGeneric>> collectionOfCollectionOfSomeGeneric) {
	...
	public void setCollectionOfCollectionOfExtendsSomeGeneric(
			Collection<Collection<? extends SomeGeneric>> collectionOfCollectionOfExtendsSomeGeneric) {
	...
	public void setCollectionOfAbstractCollectionOfAbstractList(
			Collection<AbstractCollection<AbstractList<SomeGeneric>>> collectionOfAbstractCollectionOfAbstractList) {
		assertThatCollectionIsOf(collectionOfAbstractCollectionOfAbstractList, ArrayList.class, ArrayList.class,
				SomeGeneric.class);
		this.collectionOfAbstractCollectionOfAbstractList = collectionOfAbstractCollectionOfAbstractList;
	}

	public void setAbstractListOfAbstractSequentialListOfArrayList(
			AbstractList<AbstractSequentialList<ArrayList<SomeGeneric>>> abstractListOfAbstractSequentialListOfArrayList) {

		assertThatCollectionIsOf(abstractListOfAbstractSequentialListOfArrayList, LinkedList.class, ArrayList.class,
				SomeGeneric.class);
		this.abstractListOfAbstractSequentialListOfArrayList = abstractListOfAbstractSequentialListOfArrayList;
	}

	public void setArrayListOfCopyOnWriteArrayListOfLinkedList(
			ArrayList<CopyOnWriteArrayList<LinkedList<SomeGeneric>>> arrayListOfCopyOnWriteArrayListOfLinkedList) {
		assertThatCollectionIsOf(arrayListOfCopyOnWriteArrayListOfLinkedList, CopyOnWriteArrayList.class,
				LinkedList.class, SomeGeneric.class);
	...
	private void assertThatCollectionIsOf(Collection collection, Class<?>... type) {
		...
		for (Object entry : collection) {
			Assertions.assertTrue(entry.getClass() == type[0]);
			if (type.length > 1) {
