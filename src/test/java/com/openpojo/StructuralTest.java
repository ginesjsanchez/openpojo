...
public class StructuralTest {
	private static final Class<?>[] NON_INSTANTIABLES = new Class<?>[]{
			com.openpojo.reflection.PojoParameter.class, com.openpojo.random.RandomFactory.class,
			com.openpojo.business.BusinessIdentity.class, com.openpojo.cache.CacheStorageFactory.class,
			...
			com.openpojo.reflection.impl.PojoFieldFactory.class, com.openpojo.reflection.impl.PojoClassFactory.class,
			com.openpojo.reflection.impl.PojoPackageFactory.class, com.openpojo.reflection.cache.PojoCache.class,
			com.openpojo.reflection.construct.InstanceFactory.class, com.openpojo.reflection.utils.ObjectToString.class,
			com.openpojo.reflection.utils.AttributeHelper.class, com.openpojo.reflection.utils.ToStringHelper.class,
			com.openpojo.reflection.java.Java.class, com.openpojo.reflection.facade.FacadeFactory.class,
			com.openpojo.random.util.Helper.class, com.openpojo.random.util.SomeEnum.class,
			...
			com.openpojo.business.utils.BusinessPojoHelper.class, com.openpojo.validation.utils.CloseableHelper.class,
			com.openpojo.validation.utils.ToStringHelper.class, com.openpojo.validation.utils.ValidationHelper.class,
			...
			com.openpojo.reflection.java.load.ClassUtil.class, com.openpojo.reflection.java.version.VersionParser.class,
			com.openpojo.reflection.java.version.VersionFactory.class, com.openpojo.random.map.util.MapHelper.class,
			...
			com.openpojo.random.generator.time.util.ReflectionHelper.class, com.openpojo.validation.affirm.Affirm.class
	};
			...
			try {
				...
				if (actual == null)
					...
					Affirm.affirmEquals("Expected message miss-match",
							pojoClass.getName() + " should not be constructed!", actual.getMessage());
			}
		}
	}
	...
	public void verifyNonInstantiableList() {
		...
		for (PojoClass entry : staticClasses)
			Affirm.affirmContains("Detected class [" + entry.getName() + "] not being tested", entry.getClazz(),
					nonInstantiables);

		for (Class<?> nonInstantiable : nonInstantiables)
			Affirm.affirmContains(
					"Detected class [" + nonInstantiable.getName() + "] being tested but was filtered out",
