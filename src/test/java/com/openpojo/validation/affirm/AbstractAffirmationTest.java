...
public abstract class AbstractAffirmationTest {
	...
	/**
	 * Test method for
	 * {@link com.openpojo.validation.affirm.Affirm#fail(java.lang.String)}.
	 */
	@Test
	public void testFail() {
		...
		Assertions.fail("Affirm.fail(String) failed to fail :)!!");
	}
	...
	public void testFailWithNullMessage() {
		...
		Assertions.fail("Affirm.fail(null) failed to fail :)!!");
	}

	/**
	 * Test method for
	 * {@link com.openpojo.validation.affirm.Affirm#affirmTrue(java.lang.String, boolean)}.
	 */
	@Test
	public void testAffirmTrue() {
		...
		Assertions.fail("Affirm.affirmTrue call on false passed!!");
	}

	/**
	 * Test method for
	 * {@link com.openpojo.validation.affirm.Affirm#affirmFalse(java.lang.String, boolean)}.
	 */
	@Test
	public void testAffirmFalse() {
		...
		Assertions.fail("Affirm.affirmFalse call on true passed!!");
	}

	/**
	 * Test method for
	 * {@link com.openpojo.validation.affirm.Affirm#affirmNotNull(java.lang.String, java.lang.Object)}.
	 */
	@Test
	public void testAffirmNotNull() {
		...
		Assertions.fail("Affirm.affirmNotNull call on null passed!!");
	}

	/**
	 * Test method for
	 * {@link com.openpojo.validation.affirm.Affirm#affirmNull(java.lang.String, java.lang.Object)}.
	 */
	@Test
	public void testAffirmNull() {
		...
		Assertions.fail("Affirm.affirmNull call on non-null passed!!");
	}
	...
	public void testAffirmEquals() {
		...
		Assertions.fail("Affirm.affirmEquals call on non-equal objects passed!");
	}
	...
	public void testAffirmSame() {
		...
		Assertions.fail("Affirm.affirmSame call on non-same objects passed");
	}
	...
	public void testAffirmContains() {
		...
		Assertions.fail("Affirm.affirmContains failed to detect that 'WHAT' is not part of the collection");
	}
	...
	public void testAffirmContainsWithNulls() {
		...
		Assertions.fail("Affirm.affirmContains failed to detect a missing null in the list");
	}
