...
public class TestNGAssertAffirmationTest extends AbstractAffirmationTest {
	...
	private final Affirmation testNGAssertAffirmation = (Affirmation) InstanceFactory
			.getInstance(PojoClassFactory.getPojoClass(TestNGAssertAffirmation.class));
	...
	public void shouldTestToString() {
		...
		Assertions.assertTrue(
				...
				String.format("[%s] signature changed? expected=[%s]!!", testNGAssertAffirmation.toString(),
