...
public class ToStringHelperTest {
	...
	public void shouldReturnNullWhenNull() {
		Assertions.assertEquals("null", safeToString(null));
	}

	@Test
	public void shouldReturnToStringWhenToStringCalled() {
		Object object = new Object();
		Assertions.assertEquals(object.toString(), safeToString(object));
	}

	@Test
	public void shouldReturnErrorMessageWhenToStringThrowsErrors() {
		Assertions.assertEquals(
				"Error calling toString: 'java.lang.RuntimeException: " + anyRandomMessage() + "'",
				safeToString(this));
	}
