...
/**
 * Default implementation of {@code BusinessKeyField}, built by reading the {@code @BusinessKey} annotation on the
 * field.
 *
 * @author oshoukry
 */
public class DefaultBusinessKeyField implements BusinessKeyField {
	...
	/**
	 * Reads the {@code @BusinessKey} annotation on the field and keeps what it declares.
	 *
	 * @param pojoField
	 *     The annotated field.
	 */
	...
	public String toString() {
		return String.format(
				"DefaultBusinessKeyField [isRequired=%s, isComposite=%s, isCaseSensitive=%s, pojoField=%s]",
