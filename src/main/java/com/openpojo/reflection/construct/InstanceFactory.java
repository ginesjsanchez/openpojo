	...
	private static Object doGetInstance(PojoClass pojoClass, Object[] parameters) {
		if (!pojoClass.isConcrete()) {
			throw ReflectionException
					.getInstance(String.format("[%s] is not a concrete class, can't create new instance", pojoClass));
		}
		...
		throw ReflectionException
				.getInstance(String.format("No matching constructor for [%s] found using parameters[%s]",
