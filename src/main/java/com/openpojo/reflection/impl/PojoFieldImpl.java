...
/**
 * This is the default implementation for PojoField Interface. This is an
 * immutable object and is not supposed to be created directly. see
 * {@link PojoClassFactory}
 *
 * @author oshoukry
 */
class PojoFieldImpl implements PojoField {
	...
	public void invokeSetter(final Object instance, final Object value) {
		try {
			...
			String message = "Null pointer exception invoking [" + fieldSetter + "] on instance [" + instance
					+ "] with value [" + value + "]";
			throw ReflectionException.getInstance(message, e);
		}
	}
	...
	public boolean isPackagePrivate() {
		...
		return (Modifier.PRIVATE & modifiers | Modifier.PROTECTED & modifiers | Modifier.PUBLIC & modifiers) == 0;
	}
