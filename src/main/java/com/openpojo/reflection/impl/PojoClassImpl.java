...
public class PojoClassImpl implements PojoClass {
	...
	/**
	 * Builds the abstraction from the class and its already resolved fields and methods.
	 *
	 * @param clazz
	...
	public List<PojoField> getPojoFieldsAnnotatedWith(Class<? extends Annotation> annotation) {
		List<PojoField> returnedFields = new LinkedList<>();
	...
	public List<PojoMethod> getPojoMethodsAnnotatedWith(Class<? extends Annotation> annotation) {
		List<PojoMethod> returnedMethods = new LinkedList<>();
	...
	public List<PojoMethod> getPojoConstructors() {
		final List<PojoMethod> constructors = new LinkedList<>();
	...
	public String toString() {
		return String.format(this.getClass().getName() + " [clazz=%s, pojoFields=%s, pojoMethods=%s]", clazz,
				pojoFields,
				pojoMethods);
	}
	...
	public List<PojoClass> getInterfaces() {
		final List<PojoClass> interfaces = new LinkedList<>();
	...
	public String getSourcePath() {
		try {
			...
			final URL location = cl
					.getResource(getClazz().getName().replace(Java.PACKAGE_DELIMITER, Java.PATH_DELIMITER)
