...
/**
 * Default implementation of {@code SubClassDefinition}.
 *
 * @author oshoukry
 */
public class DefaultSubClassDefinition implements SubClassDefinition {
	...
	/**
	 * Defines a subclass of the given class with a name derived from its own.
	 *
	 * @param parentClass
	 *     The class to extend.
	 */
	...
	/**
	 * Defines a subclass of the given class with a specific name.
	 *
	 * @param parentClass
	 *     The class to extend.
	 * @param subClassName
	 *     The name to give the subclass.
	 */
